...
const formatUserTag = (username?: string | null, discriminator?: string | null): string => {
...
Log.success(
	`Logged in as ${chalk.bold(
		formatUserTag(client.user?.username, client.user?.discriminator)
...
if (!_confirmRaid) throw userDeclinedError
